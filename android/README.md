...
2. 粘贴抖音、小红书、知乎、X、Instagram 或 B站分享文本并点击“解析作品”。
...
也可以在支持平台的分享面板中选择本应用。作品分享进入后应用会自动开始解析。
...
纯文本帖子不会创建任务。当前不支持仅有 HLS 的视频、Spaces、直播和外部站点嵌入媒体。
...
- 抖音、小红书、知乎和 X 都没有面向此用途的公开稳定下载 API，Cookie、签名或字段变化后可能需要
  更新 APK。
...
- 小红书作者主页和批量下载已停止支持；已有小红书作者缓存不会删除，单作品任务与下载文件
  不受影响。抖音、知乎、X、Instagram 和 B站支持作者页及批量下载。
