...
object PublicStorage {
    fun ensureDestination(context: Context, spec: TaskSpec) {
        ...
        if (mode == StorageMode.SAF) {
            ...
            val directory = StorageInspector.newDefaultTaskDirectory(spec.taskFolder)
    ...
    fun publish(
        ...
        val values = ContentValues().apply {
            ...
            put(
                ...
                "${Environment.DIRECTORY_DOWNLOADS}/${ProductIdentity.DEFAULT_DOWNLOAD_DIRECTORY}/${spec.taskFolder}" +
